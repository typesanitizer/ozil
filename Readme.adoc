= ozil - A man with intelligence and vision image:https://travis-ci.com/theindigamer/ozil.svg?branch=master["Build Status", link="https://travis-ci.com/theindigamer/ozil"]
:idprefix:
:idseparator: -
:sectanchors:
:sectlinks:
